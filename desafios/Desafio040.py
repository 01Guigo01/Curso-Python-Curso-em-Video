...
# Pede as notas dos 4 bimestres (sem tratamento de erro)
...
# Determina o resultado com base na média, usando apenas IF/ELIF
if average < 5:
    # Cores e emojis para REPROVADO
...
elif 5 <= average <= 6.9: # Condição explícita para RECUPERAÇÃO
