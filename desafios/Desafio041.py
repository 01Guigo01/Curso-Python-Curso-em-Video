...
if current_age <= 9:
    print(f"\n🎉 Você é um jovem entusiasta! Com {current_age} anos, sua categoria é: \033[1;36mMIRIM\033[m!")
elif current_age > 9 and current_age <= 14:
    print(f"\n🚀 Que energia! Com {current_age} anos, sua categoria é: \033[1;34mINFANTIL\033[m!")
elif current_age > 14 and current_age <= 19:
    print(f"\n🌟 Arrasando! Com {current_age} anos, sua categoria é: \033[1;35mJUNIOR\033[m!")
elif current_age > 19 and current_age <= 24:
    print(f"\n🏆 Experiência crescendo! Com {current_age} anos, sua categoria é: \033[1;32mSÊNIOR\033[m!")
else:
    print(f"\n👑 Mestre da sua categoria! Com {current_age} anos, você está na categoria: \033[1;33mMASTER\033[m!")
print("\n" + "=" * 50)
